...
class Map:
    ...
    def set_stage1(self, from_):
        if from_ == 2:
            self.mario.set_position([160, 150])
        else:
            self.mario.set_position([15, 150])
        self.coins = [Coin([90, 90]), Coin([120, 90])]
        self.mushrooms = []
        self.pipes = []
